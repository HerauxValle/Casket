...
def cmd_backup_list(name, base):
    ...
    if not snaps:
        log(f"  no snapshots yet — create one with:  cas {name} backup create <n>")
        return
